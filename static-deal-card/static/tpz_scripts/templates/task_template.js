...
export class Template {
                ...
                <td class="block-center">
                    <div class="task-container__item-dismantling">
                        ...
                        <div class="task-container__item-dismantling-cost-price">
                            <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="себест. демонтожа" title="себест. демонтожа" value="${this.customToString(productData.dismantlingCost)}" data-product-field="dismantlingCost" data-type="number" data-group-id="${groupId}" data-product-id="${productData.id}" ${this.editable ? '' : 'readonly'}>
                        </div>
                    </div>
                </td>
                ${businessTripHTML}
                    ...
                    <div class="task-container__item-delivery-container">
                        <div class="task-container__item-delivery">
                            <div class="task-container__item-delivery-count">
                                <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="сколько раз" title="сколько раз" value="${this.customToString(productData.deliveryFrequency)}" data-product-field="deliveryFrequency" data-type="number" data-group-id="${groupId}" data-product-id="${productData.id}" ${this.editable ? '' : 'readonly'}>
                            </div>
                            <div class="task-container__item-delivery-mul"><i class="bi bi-x"></i></div>
                            <div class="task-container__item-delivery-price">
                                <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="себес. доставки за раз" title="себес. доставки за раз" value="${this.customToString(productData.deliveryCostPerTime)}" data-product-field="deliveryCostPerTime" data-type="number" data-group-id="${groupId}" data-product-id="${productData.id}" ${this.editable ? '' : 'readonly'}>
                            </div>
                        </div>
                    </div>
                </td>
            ...
            contentHTML += `
                <div class="task-container__item-consumption-item technology-row" data-technology-id="${technology.id}">
                    ...
                    <div class="task-container__item-consumption-item-title">
                        <input class="${this.editable ? 'employee-dis' : ''}" type="text" name="" id="" placeholder="ЧПП" title="${this.customToString(technology.CHPP)}" value="${this.customToString(technology.CHPP)}" data-technology-field="CHPP" data-type="text" data-group-id="${groupId}" data-product-id="${productId}" data-technology-id="${technology.id}" ${this.editable ? '' : 'readonly'}>
                    </div>
        ...
        for (let technology of technologies) {
            contentHTML += `
                <div class="task-container__item-area-mounting technology-item technology-row " data-technology-id="${technology.id}">
                    <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="Площадь монтажа" title="${this.customToString(technology.installArea)}" value="${this.customToString(technology.installArea)}" data-technology-field="installArea" data-type="number" data-group-id="${groupId}" data-product-id="${productId}" data-technology-id="${technology.id}" ${this.editable ? '' : 'readonly'}>
                </div>
            `;
        }
            ...
            contentHTML += `
                <div class="task-container__item-amount technology-item technology-row" data-technology-id="${technology.id}">
                    <div class="task-container__item-amount-costprice">
                        <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="себест. монт." title="${this.customToString(technology.installCost)}" value="${this.customToString(technology.installCost)}" data-technology-field="installCost" data-type="number" data-group-id="${groupId}" data-product-id="${productId}" data-technology-id="${technology.id}" ${this.editable ? '' : 'readonly'}>
                    </div>
                </div>
            `;
        }
            ...
            contentHTML += `
                <div class="task-container__item-summary-percent technology-item technology-row" data-technology-id="${technology.id}">
                    ...
                    <div class="task-container__item-summary-percent-value">
                        <input type="number" name="" id="" title="${this.customToString(technology.totalPercent)}" value="${this.customToString(technology.totalPercent)}" data-technology-field="totalPercent" data-type="number" data-group-id="${groupId}" data-product-id="${productId}" data-technology-id="${technology.id}" ${this.editable ? '' : 'readonly'}>
                    </div>
        ...
        for (let technology of technologies) {
            ...
            contentHTML += `
                <div class="task-container__item-added technology-item technology-row" data-technology-id="${technology.id}">
                    <input type="checkbox" name="" id="" ${checked} data-technology-field="addedToOrder" data-type="checkbox" data-group-id="${groupId}" data-product-id="${productId}" data-technology-id="${technology.id}" ${this.editable ? '' : 'readonly'}>
                </div>
            `;
        }
    ...
    getBusinessTripHTML(groupData, technologiesCount) {
                ...
                <td class="shared block-center" style="grid-row: span ${technologiesCount}">
                    <div class="task-container__item-business-trip">
                        <div class="task-container__item-business-trip-type">
                            <select class="task-container_group-item-dismantling-bottom ${this.editable ? 'employee-mos' : ''}" name="" id="" title="${this.getTitleFromEnums(this.fields?.group?.[SP_GROUP_FIELDS.businessTrip]?.items, groupData.businessTrip)}" data-group-field="businessTrip" data-type="select" data-group-id="${groupData.id}">
                                ${this.getOptionsHTML(this.fields?.group?.[SP_GROUP_FIELDS.businessTrip]?.items, groupData.businessTrip, true)}
                            </select>
                        </div>
                        <div class="task-container__item-dismantling-count-workers">
                            <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="сколько человек" title="сколько человек" value="${this.customToString(groupData.businessTripPeople)}" data-group-field="businessTripPeople" data-type="number" data-group-id="${groupData.id}" ${this.editable ? '' : 'readonly'}>
                        </div>
                        <div class="task-container__item-dismantling-count-days">
                            <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="сколько дней" title="сколько дней" value="${this.customToString(groupData.businessTripDays)}" data-group-field="businessTripDays" data-type="number" data-group-id="${groupData.id}" ${this.editable ? '' : 'readonly'}>
                        </div>
                        <div class="task-container__item-dismantling-count-nights">
                            <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="проживание ночей" title="проживание ночей" value="${this.customToString(groupData.businessTripAccommodation)}" data-group-field="businessTripAccommodation" data-type="number" data-group-id="${groupData.id}" ${this.editable ? '' : 'readonly'}>
                        </div>
                        <div class="task-container__item-dismantling-count-eating-days">
                            <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="питание дней" title="питание дней" value="${this.customToString(groupData.businessTripNutritions)}" data-group-field="businessTripNutritions" data-type="number" data-group-id="${groupData.id}" ${this.editable ? '' : 'readonly'}>
                        </div>
                        <div class="task-container__item-dismantling-count-miles">
                            <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="пробег" title="пробег" value="${this.customToString(groupData.businessTripMileages)}" data-group-field="businessTripMileages" data-type="number" data-group-id="${groupData.id}" ${this.editable ? '' : 'readonly'}>
                        </div>
                    </div>
                </td>
            `;
        ...
        return `
            <td class="shared block-center" style="grid-row: span ${technologiesCount}">
                <div class="task-container__item-business-trip-departure">
                    <div class="task-container__item-business-trip-type">
                        <select class="task-container_group-item-dismantling-bottom ${this.editable ? 'employee-mos' : ''}" name="" id="" title="${this.getTitleFromEnums(this.fields?.group?.[SP_GROUP_FIELDS.businessTrip]?.items, groupData.businessTrip)}" data-group-field="businessTrip" data-type="select" data-group-id="${groupData.id}">
                            ${this.getOptionsHTML(this.fields?.group?.[SP_GROUP_FIELDS.businessTrip]?.items, groupData.businessTrip, true)}
                        </select>
                    </div>
                    <div class="task-container__item-business-trip-type-departure">
                        <select class="task-container_group-item-dismantling-bottom ${this.editable ? 'employee-mos' : ''}" name="" id="" title="${this.getTitleFromEnums(this.fields?.group?.[SP_GROUP_FIELDS.businessTripTypeDeparture]?.items, groupData.businessTripTypeDeparture)}" data-group-field="businessTripTypeDeparture" data-type="select" data-group-id="${groupData.id}">
                            ${this.getOptionsHTML(this.fields?.group?.[SP_GROUP_FIELDS.businessTripTypeDeparture]?.items, groupData.businessTripTypeDeparture, true)}
                        </select>
                    </div>
                    <div class="task-container__item-business-trip-count-workers">
                        <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="сколько человек" title="сколько человек" value="${this.customToString(groupData.businessTripPeople)}" data-group-field="businessTripPeople" data-type="number" data-group-id="${groupData.id}" ${this.editable ? '' : 'readonly'}>
                    </div>
                    <div class="task-container__item-business-trip-count">
                        <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="проживание ночей" title="проживание ночей" value="${this.customToString(groupData.businessTripCount)}" data-group-field="businessTripCount" data-type="number" data-group-id="${groupData.id}" ${this.editable ? '' : 'readonly'}>
                    </div>
                    <div class="task-container__item-business-trip-cost-one">
                        <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="питание дней" title="питание дней" value="${this.customToString(groupData.businessTripCostOne)}" data-group-field="businessTripCostOne" data-type="number" data-group-id="${groupData.id}" ${this.editable ? '' : 'readonly'}>
                    </div>
                </div>
            </td>
        `;
                ...
                <div class="task-container__item-delivery-cp-container">
                    <div class="task-container__item-delivery-cp">
                        ...
                        <div class="task-container__item-delivery-cp-cost">
                            <input class="${this.editable ? 'employee-mos' : ''}" type="number" name="" id="" placeholder="себес. курьер. ЦП" title="${this.customToString(groupData.deliveryCost)}" value="${this.customToString(groupData.deliveryCost)}" data-group-field="deliveryCost" data-type="number" data-group-id="${groupData.id}" ${this.editable ? '' : 'readonly'}>
                        </div>
                    </div>
                </div>
            </td>
