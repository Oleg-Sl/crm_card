...
class DealFiles {
    constructor(container, bx24, yaDisk, dealId, cbChangedFiles) {
        this.container = container;
        this.bx24 = bx24;
        this.yaDisk = yaDisk;
        this.dealId = dealId;
...
class DealLinks {
    constructor(container, bx24, cbChangedLinks) {
        this.container = container;
        this.bx24 = bx24;
...
export default class DealSources {
    ...
    init(dealData) {
        ...
        this.objLinks.init(links);
        this.objFiles.init(files);
        // this.objLinks = new DealLinks(this.boxLinks, this.bx24, links, this.notify.bind(this));
        // this.objFiles = new DealFiles(this.boxFiles, this.bx24, this.yaDisk, this.dealId, files, this.notify.bind(this));
        this.notify();
    }
    ...
    getChangedData() {
        return {
            ...
            [FIELD_DEAL_SOURCE_FILES]: this.objFiles.getData().length > 0 ? this.objFiles.getData() : [''],
        }
    }
