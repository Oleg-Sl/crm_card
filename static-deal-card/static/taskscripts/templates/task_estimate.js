...
export class TemplatesEstimateTask {
    constructor() {
        this.fields = {};
        this.materials = {};
    }
                ...
                <td class="block-center">
                    <div class="task-container__item-business-trip">
                        ...
                        <div class="task-container__item-dismantling-count-workers">
                            <input type="number" name="" id="" placeholder="сколько. человек" value="${this.customToString(productData.businessTripPeople)}" data-product-field="businessTripPeople" data-type="number" data-group-id="${groupId}" data-product-id="${productData.id}">
                        </div>
                        <div class="task-container__item-dismantling-count-days">
                            <input type="number" name="" id="" placeholder="сколько дней" value="${this.customToString(productData.businessTripDays)}" data-product-field="businessTripDays" data-type="number" data-group-id="${groupId}" data-product-id="${productData.id}">
                        </div>
                        <div class="task-container__item-dismantling-count-nights">
                            <input type="number" name="" id="" placeholder="проживание ночей" value="${this.customToString(productData.businessTripAccommodation)}" data-product-field="businessTripAccommodation" data-type="number" data-group-id="${groupId}" data-product-id="${productData.id}">
                        </div>
                        <div class="task-container__item-dismantling-count-eating-days">
                            <input type="number" name="" id="" placeholder="питание дней" value="${this.customToString(productData.businessTripNutritions)}" data-product-field="businessTripNutritions" data-type="number" data-group-id="${groupId}" data-product-id="${productData.id}">
                        </div>
                        <div class="task-container__item-dismantling-count-miles">
                            <input type="number" name="" id="" placeholder="пробег" value="${this.customToString(productData.businessTripMileages)}" data-product-field="businessTripMileages" data-type="number" data-group-id="${groupId}" data-product-id="${productData.id}">
                        </div>
                    </div>
                </td>
                <td class="block-center">
