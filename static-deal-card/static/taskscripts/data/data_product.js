...
export class Product {
    constructor(data) {
        ...
        this.businessTripPeople = data?.[SP_PRODUCT_FIELDS.businessTripPeople] || [];               // Командировка - сколько человек
        this.businessTripDays = data?.[SP_PRODUCT_FIELDS.businessTripDays] || [];                   // Командировка - сколько дней
